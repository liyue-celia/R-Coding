...
Use underline to connect the words, for example, first_name
...
1.it contains letters, numbers, underline and point.
2.it can not start with numbers and underline
3.it can not start with a point followed by numbers
4.Some names are forbidden. These include reserved words like FALSE and TRUE, core programming words like Inf, for, else, break, function, and words for special entities like NA and NaN.
5.Some names we should not use which are already in use for objects or functions that form part of the core of R.
6.Do not use spaces when naming things, including variables in your data.

Not valid names for example,
123celia; 123 coding; FALSE
...
I think the Usage part is more useful!
